...
public class Background extends Actor {
    ...
    public Background() {
        textureRegion = new TextureRegion(new Texture(Gdx.files.internal("data/level1.png")));
        textureRegionBounds1 = new Rectangle(0 , 0, textureRegion.getRegionWidth(), textureRegion.getRegionHeight());
